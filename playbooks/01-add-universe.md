...
- Archive copy must sound natural for anime fans and avoid internal ranking, recommendation, or growth-system language.
- Confirm catalog metadata supports browse defaults (`addedAt`, popularity baseline, and optional featured rank) or allow safe fallback behavior.

...
Use `docs/MASTER_UNIVERSE_BUILD_PROMPT.md` (canonical) and `docs/MASTER_RESEARCH_PROMPT.md` (companion) to normalize **pre-supplied** research into implementation-ready structure.

...
export const UNIVERSE_CATALOG = [
  ...
  {
    id: 'frieren', anime: 'Sousou no Frieren', tagline: 'A post-war fantasy where mana deception, lifespan asymmetry, and visualization limits decide who survives.', malId: 52991, visualizationHint: 'timeline', visualizationReason: 'Frieren\'s core thesis is causal and longitudinal: Flamme\'s anti-demon doctrine, millennium-scale mana training, the Demon King\'s defeat, and current-era mage institutions all form a delayed-consequence chain that the timeline renderer explains best.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1015/138006l.jpg',
  ...
  {
    id: 'sololeveling', anime: 'Solo Leveling', tagline: 'A fixed-rank hunter economy is broken by one player running an infinite growth protocol.', malId: 52299, visualizationHint: 'node-graph', visualizationReason: 'Solo Leveling is defined by control links between cosmic factions, vessel inheritance, and gate-driven dependencies; the node graph best exposes who grants power, who exploits it, and how Jinwoo rewires the network.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1801/142390l.jpg',
  ...
  {
    id: 'mushokutensei', anime: 'Mushoku Tensei: Jobless Reincarnation', tagline: 'A reincarnation-driven fate system where mana growth, bloodline factors, and looping causality decide civilization-scale outcomes.', malId: 39535, visualizationHint: 'timeline', visualizationReason: 'Mushoku Tensei is fundamentally a delayed-causality system: ancient god-war fallout, Laplace-era fragmentation, and present-era choices all compound across centuries, so the timeline renderer captures the thesis best.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1530/117776l.jpg',
  ...
  {
    id: 'black-clover', anime: 'Black Clover', tagline: 'Anti-magic versus elemental sovereignty — a kingdom bets on the underdog', malId: 34572, visualizationHint: 'affinity-matrix', visualizationReason: "Black Clover's magic system is an affinity matrix: five elements organize spell interactions, four-leaf grimoires create rare nodes, and anti-magic represents a null-edge that breaks the entire grid.", animeImageUrl: 'https://cdn.myanimelist.net/images/anime/2/88336l.jpg',
    themeColors: { primary: '#1e3a5f', secondary: '#0f172a', accent: '#fbbf24', glow: 'rgba(30,58,95,0.30)', tabActive: '#2563eb', badgeBg: 'rgba(15,23,42,0.55)', badgeText: '#93c5fd', modeGlow: 'rgba(251,191,36,0.28)', heroGradient: 'rgba(2,6,23,0.93)' },
    stats: { characters: 25, powerSystem: 4, rules: 4 }
  },
  {
    id: 're-zero', anime: 'Re:Zero - Starting Life in Another World', tagline: 'Save-scum your way to victory - if you are willing to die enough times', malId: 31240, visualizationHint: 'counter-tree', visualizationReason: 'Re:Zero Return by Death creates a counter-tree where each death branches the exploration graph. Witch factors add competing authority nodes, and the witch cult forms a counter-coalition.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1522/128039l.jpg',
    themeColors: { primary: '#7c3aed', secondary: '#0f172a', accent: '#c4b5fd', glow: 'rgba(124,58,237,0.30)', tabActive: '#8b5cf6', badgeBg: 'rgba(15,23,42,0.55)', badgeText: '#c4b5fd', modeGlow: 'rgba(196,181,253,0.28)', heroGradient: 'rgba(2,6,23,0.93)' },
    stats: { characters: 20, powerSystem: 4, rules: 4 }
  },
  {
    id: 'blue-lock', anime: 'Blue Lock', tagline: '300 forwards enter Blue Lock. Only one egoist survives.', malId: 49596, visualizationHint: 'counter-tree', visualizationReason: 'Blue Lock is structurally a counter-tree: each striker\'s ego vision competes as an individual optimization path, and the Blue Lock project eliminates collaborative paths until only pure individual capability remains.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1258/126929l.jpg',
    themeColors: { primary: '#1d4ed8', secondary: '#0c0f1a', accent: '#f97316', glow: 'rgba(59,130,246,0.35)', tabActive: '#3b82f6', badgeBg: 'rgba(12,15,26,0.55)', badgeText: '#bae6fd', modeGlow: 'rgba(249,115,22,0.3)', heroGradient: 'rgba(2,6,23,0.94)' },
    stats: { characters: 8, powerSystem: 4, rules: 4 }
  },
  {
    id: 'sword-art-online', anime: 'Sword Art Online', tagline: '10,000 players trapped in a death-game. Only victory frees them.', malId: 11757, visualizationHint: 'node-graph', visualizationReason: 'SAO is structurally a dependency graph: sword skills link to weapon type nodes, guilds create party coordination networks, and the death-game condition makes every clearing decision a matter of survival.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/11/39717l.jpg',
    themeColors: { primary: '#0ea5e9', secondary: '#0c0f1a', accent: '#a855f7', glow: 'rgba(14,165,233,0.35)', tabActive: '#38bdf8', badgeBg: 'rgba(12,15,26,0.55)', badgeText: '#bae6fd', modeGlow: 'rgba(168,85,247,0.3)', heroGradient: 'rgba(2,6,23,0.94)' },
    stats: { characters: 8, powerSystem: 4, rules: 4 }
  },
  {
    id: 'tokyo-revengers', anime: 'Tokyo Revengers', tagline: 'A time-leaping delinquent rewrites bloody futures by navigating linear past events.', malId: 42249, visualizationHint: 'timeline', visualizationReason: 'Time-leaping in Tokyo Revengers is fundamentally a linear backward navigation mechanic: Takemichi rewinds to a fixed past point, makes changes, and must chain subsequent leaps to reach his desired future outcome.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1839/122012l.jpg',
  ...
  },
  {
    ...
    stats: { characters: 8, powerSystem: 4, rules: 3 }
  },
  {
    id: 'spy-x-family', anime: 'Spy x Family', tagline: 'A spy, an assassin, and a telepath form a fake family—each hiding their real job from the others.', malId: 50265, visualizationHint: 'affinity-matrix', visualizationReason: 'Spy x Family has no unified power system—each family member operates with an individual ability set (spy tradecraft, assassination, telepathy), and the narrative tension comes from their individual cards being revealed selectively, making it a perfect affinity-matrix.', animeImageUrl: 'https://cdn.myanimelist.net/images/anime/1441/122795l.jpg',

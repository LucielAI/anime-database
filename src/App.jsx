        ...
        {primaryFeatured && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <Link
              ...
              className="lg:col-span-2 rounded-xl border border-white/10 bg-white/5 overflow-hidden hover:border-cyan-400/40 transition-all relative min-h-[280px] md:min-h-[340px]"
            >
              ...
              <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-300 leading-relaxed max-w-xl">{primaryFeatured.tagline}</p>
                </div>
                <span className="mt-5 inline-flex items-center gap-2 text-xs text-white/90 uppercase tracking-[0.15em]">Enter archive <ArrowRight className="w-3.5 h-3.5" /></span>
              </div>
            </Link>

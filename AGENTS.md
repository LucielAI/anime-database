...
npm run validate:all                                          # archive-wide audit of integrated payloads
...
# Build & test
npm run build                                                  # production build (regenerates sitemap)
...
| Canonical universe build prompt | `docs/MASTER_UNIVERSE_BUILD_PROMPT.md` |

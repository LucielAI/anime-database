...
// INSIGHTS_MAP — keep in sync manually with api/og.js
const INSIGHTS_MAP = {
...
// Generate the output file — write as plain JS string to avoid newline escaping issues
const NL = '\n'
...
const output = `// AUTO-GENERATED by scripts/generate-og-map.js — do not edit manually${NL}${universeBlock}${NL}${NL}${insightBlock}${NL}`
